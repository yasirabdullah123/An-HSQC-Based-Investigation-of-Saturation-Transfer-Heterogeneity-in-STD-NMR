...
# File paths
const CCPN_BMRB_REFERENCE_FILE = "bmrbsyntheticpeaklist.tsv"  # CCPN-generated synthetic reference
const CCPN_EXPERIMENTAL_FILE = "ccpnTable2.tsv"  # Experimental peak list
const REFERENCE_SPECTRUM = "4"
...
# Output files
const MASTER_PEAK_LIST_FILE = "master-peak-list-rbh-optimized.tsv"
...
function optimized_reciprocal_best_hit_algorithm(exp_data, bmrb_data; h_tolerance=H_TOLERANCE, c_tolerance=C_TOLERANCE)
    ...
    # Filter by tolerance (normalized distance ≤ 1.0)
    println("Applying tolerance filter...")
